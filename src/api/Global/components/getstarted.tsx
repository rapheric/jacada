  ...
  return (
    <div>
      <div className="mt-8 flex flex-col md:flex-row gap-4 mb-4 max-w-7xl mx-auto flex items-center justify-center">
        ...
        <button className="bg-transparent border-2 border-gray-400 hover:border-white text-white hover:text-gray-100 text-base font-semibold px-6 py-3 rounded-lg transform transition duration-300 hover:scale-105 hover:bg-gray-800 hover:shadow-lg">
          Request a demo
        </button>
      </div>
    </div>
